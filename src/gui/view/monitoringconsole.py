...
class MonitoringConsole(LabelFrame):
    def __init__(self, parent, **kwargs):
        ...
        self.v1_label.grid(row=0, column=1, padx=5, pady=(5, 0), sticky=tk.E)
        self.v1_entry = tk.Entry(self, textvariable=self.runecdstat, state=tk.DISABLED)
        self.v1_entry.grid(row=0, column=2, padx=(0, 5), pady=(5, 0), sticky=tk.EW)

        self.v2_label = tk.Label(self, text='Time to next EXP Buff:')
        self.v2_label.grid(row=1, column=1, padx=5, pady=(5, 0), sticky=tk.E)
        self.v2_entry = tk.Entry(self, textvariable=self.nextexpbuffstat, state=tk.DISABLED)
        self.v2_entry.grid(row=1, column=2, padx=(0, 5), pady=(5, 0), sticky=tk.EW)

        self.v3_label = tk.Label(self, text='Time to next CS Reset:')
        self.v3_label.grid(row=2, column=1, padx=5, pady=(5, 0), sticky=tk.E)
        self.v3_entry = tk.Entry(self, textvariable=self.nextcsresetstat, state=tk.DISABLED)
        self.v3_entry.grid(row=2, column=2, padx=(0, 5), pady=(5, 0), sticky=tk.EW)

        self.v3_label = tk.Label(self, text='No. of Other Players:')
        self.v3_label.grid(row=3, column=1, padx=5, pady=(5, 0), sticky=tk.E)
        self.v3_entry = tk.Entry(self, textvariable=self.noOthers, state=tk.DISABLED)
